...
public class WrapperClass유용한메소드 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Stirng --> int,double,boolean...");
		int i1 = Integer.parseInt("54262456");
		...
		if(wc1==wc2) {
			...
			System.out.println("wc1==wc2 주소다르다.");
		}
		*/
		/*
		 * Wrapper객체의 값 비교는 equals메소드를 사용해야한다.
		 */
		if(wc1.equals(wc2)) {
			System.out.println("wc1의 char값과 wc2의 char값이 동일하다.");
		}
		
		String strs = "Hello Java!!$@##^#$%#)_#$)_)@#%_ #02 143ㄷ 가네ㅐㅊ";
